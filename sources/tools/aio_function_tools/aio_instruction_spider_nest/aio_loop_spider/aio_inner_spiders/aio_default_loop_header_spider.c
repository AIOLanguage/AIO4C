...
void weave_default_loop_materials_for(void *parent, const_string _, struct point_watcher *header_watcher,
                                      struct aio_spider *spider) {
    header_watcher->pointer = header_watcher->end;
    aio_main_loop_materials *dst_materials = parent->get.loop_materials->from.main;
    aio_default_loop_header_materials *src_materials = spider->get.loop_materials->from.default_loop_header;
