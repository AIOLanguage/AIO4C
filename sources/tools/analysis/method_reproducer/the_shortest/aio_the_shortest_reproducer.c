...
void reproduceTheShortestMethod(aio_file *object, aio_method_definition *method_definition,
    ...
    if (is_method_in_the_other_file(word)) {
        ...
        aio_file *next_object = get_aio_context_in_map_by_name(object_manager->objectMap,
        ...
        next_object = get_aio_context_in_map_by_name(object_manager->objectMap, next_object_name);
