...
aio_variable *get_aio_variable_in_map_by_name(aio_variable_definition_map *variable_definition_map, const_string name);

void delete_aio_variable_map(aio_variable_definition_map *variable_definition_map);
