...
typedef struct aio_function_instruction_list {
    int capacity;
    int size;
    aio_function_instruction **instructions;
} aio_function_instruction_list;

aio_function_instruction_list *new_aio_instruction_list();

void add_aio_instruction_in_list(aio_function_instruction_list *list, struct aio_instruction *instruction);
